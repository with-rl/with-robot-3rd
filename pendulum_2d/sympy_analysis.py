...
def forward_kinematics():
    ...
    alpha_0, a_0, theta_1, d_1 = sy.symbols("alpha_0, a_0, theta_1, d_1", real=True)
    ...
    #
    # Joint_0 Frame -> Joint_1 Frame
    #
    T_01 = dh_transformation(alpha_0, a_0, theta_1, d_1)
    print(f"T_01 = {T_01}")
    T_01 = T_01.subs([(alpha_0, 0)]).subs([(a_0, -0.4)]).subs([(d_1, 0.101)])
    print(f"T_01 = {T_01}")
    print()

    #
    # Station Frame -> Joint_1 Frame
    #
    T_S1 = sy.simplify(T_SB * T_B0 * T_01)
    print(f"T_S1 = {T_S1}")
    print()
    return T_S1
