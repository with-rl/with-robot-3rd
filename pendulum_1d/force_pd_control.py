...
class ForcePDControl(Pendulum1D):
    ...
    def pd_control(self, error, error_d):
        force_0 = self.Kp * error + self.Kd * error_d
    ...
    def run_step(self, count):
        if self.control_flag:
            ...
            self.control.force_0 = self.pd_control(error, error_d)
        else:
